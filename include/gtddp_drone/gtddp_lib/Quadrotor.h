...
public:
     ...
     */
    Quadrotor(){} // Call the System constructor.
    ...
    std::deque<Eigen::VectorXd> feedforward_controls(Eigen::VectorXd current_state, const std::deque<Eigen::VectorXd>& u_traj, const std::deque<Eigen::MatrixXd>& K_traj, const std::deque<Eigen::VectorXd>& x_traj);
private:
